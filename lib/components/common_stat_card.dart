...
class CommonStatCard extends StatelessWidget {
  ...
  CommonStatCard({super.key, required this.isCoach, required this.challenge, required this.index, this.pWidth});
    ...
    return isCoach == true
                ...
                Row(
                  children: [
                    Container(
                      ...
                      width: 12,
                      decoration: BoxDecoration(
                        color: (challenge.timeStatus ?? "").toLowerCase() == "expired" ? AppColor.redColor : AppColor.successColor,
                        borderRadius: BorderRadius.circular(
                          4,
                        ),
                      ),
                    ...
                    Text(
                      ...
                      style: TextStyle().normal16w500.textColor(
                            (challenge.timeStatus ?? "").toLowerCase() == "expired" ? AppColor.redColor : AppColor.successColor,
                          ),
                    ),
                  ],
                ),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Gap(14),
                      CommonProgressBar(
                        value: getProgressPercent(challenge.participateCount),
                        width: pWidth ?? MediaQuery.of(context).size.width - 96,
                      ),
                    ],
                  ),
                ),
        ...
        : Stack(
            ...
            children: [
              ...
              Container(
                margin: EdgeInsets.only(top: index == 0 ? 0 : 16),
                decoration: BoxDecoration(color: AppColor.white, borderRadius: BorderRadius.only(bottomLeft: Radius.circular(8)), boxShadow: [
                  BoxShadow(offset: Offset(0, 0), blurRadius: 0.3, color: AppColor.black12Color.withValues(alpha: 0.48), spreadRadius: -1)
                ]),
